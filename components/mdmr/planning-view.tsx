...
export function PlanningView() {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-2xl p-4" style={{ background: 'oklch(0.11 0.014 150 / 0.55)', backdropFilter: 'blur(20px) saturate(1.6)', border: '1px solid oklch(1 0 0 / 0.09)', boxShadow: 'inset 0 1px 0 oklch(1 0 0 / 0.10), inset 0 -1px 0 oklch(0 0 0 / 0.25), 0 4px 20px oklch(0 0 0 / 0.40)' }}>
      ...
      <section className="flex flex-col gap-3">
        ...
        <div className="rounded-2xl p-3" style={{ background: 'oklch(0.12 0.016 150 / 0.55)', backdropFilter: 'blur(20px) saturate(1.6)', border: '1px solid oklch(1 0 0 / 0.09)', boxShadow: 'inset 0 1px 0 oklch(1 0 0 / 0.10), inset 0 -1px 0 oklch(0 0 0 / 0.22), 0 4px 16px oklch(0 0 0 / 0.35)' }}>
          ...
          <div className="mt-2 flex gap-2">
            <Input
              ...
              className="" style={{ background: 'oklch(0.13 0.018 150 / 0.55)', backdropFilter: 'blur(12px) saturate(1.4)', border: '1px solid oklch(1 0 0 / 0.09)', boxShadow: 'inset 0 1px 0 oklch(1 0 0 / 0.08)' }}
            />
            <Button
              type="button"
              onClick={() => {
      ...
      <section className="flex flex-col gap-3">
        ...
        <form onSubmit={handleAddPiggyBank} className="grid grid-cols-1 gap-2 rounded-2xl " style={{ background: "oklch(0.12 0.016 150 / 0.55)", backdropFilter: "blur(20px) saturate(1.6)", border: "1px solid oklch(1 0 0 / 0.09)", boxShadow: "inset 0 1px 0 oklch(1 0 0 / 0.10), inset 0 -1px 0 oklch(0 0 0 / 0.22), 0 4px 16px oklch(0 0 0 / 0.35)" }}>
        ...
        {piggyBanks.map(item => {
          ...
          return (
            <div key={item.id} className="rounded-2xl  p-3" style={{ background: 'oklch(0.11 0.015 150 / 0.50)', backdropFilter: 'blur(16px) saturate(1.5)', border: '1px solid oklch(1 0 0 / 0.07)', boxShadow: 'inset 0 1px 0 oklch(1 0 0 / 0.07), inset 0 -1px 0 oklch(0 0 0 / 0.18), 0 2px 8px oklch(0 0 0 / 0.25)' }}>
              ...
              <Input
                ...
                className="mt-3" style={{ background: 'oklch(0.13 0.018 150 / 0.55)', backdropFilter: 'blur(12px) saturate(1.4)', border: '1px solid oklch(1 0 0 / 0.09)', boxShadow: 'inset 0 1px 0 oklch(1 0 0 / 0.08)' }}
              />
      ...
      <section className="flex flex-col gap-3">
        ...
        <form onSubmit={handleAddGoal} className="rounded-2xl " style={{ background: "oklch(0.12 0.016 150 / 0.55)", backdropFilter: "blur(20px) saturate(1.6)", border: "1px solid oklch(1 0 0 / 0.09)", boxShadow: "inset 0 1px 0 oklch(1 0 0 / 0.10), inset 0 -1px 0 oklch(0 0 0 / 0.22), 0 4px 16px oklch(0 0 0 / 0.35)" }}>
          ...
          <div className="flex flex-col gap-2">
            <Input
              ...
              required
            />
            <div className="flex gap-2 rounded-xl  p-1" style={{ background: 'oklch(0.13 0.018 150 / 0.55)', backdropFilter: 'blur(12px)', border: '1px solid oklch(1 0 0 / 0.07)', boxShadow: 'inset 0 1px 0 oklch(1 0 0 / 0.06)' }}>
              <button
                type="button"
        ...
        {planningGoals.map(goal => {
          ...
          return (
            <div key={goal.id} className="rounded-2xl  p-3" style={{ background: 'oklch(0.11 0.015 150 / 0.50)', backdropFilter: 'blur(16px) saturate(1.5)', border: '1px solid oklch(1 0 0 / 0.07)', boxShadow: 'inset 0 1px 0 oklch(1 0 0 / 0.07), inset 0 -1px 0 oklch(0 0 0 / 0.18), 0 2px 8px oklch(0 0 0 / 0.25)' }}>
      ...
      <section className="flex flex-col gap-3">
        ...
        <form onSubmit={handleAddFixedCost} className="rounded-2xl " style={{ background: "oklch(0.12 0.016 150 / 0.55)", backdropFilter: "blur(20px) saturate(1.6)", border: "1px solid oklch(1 0 0 / 0.09)", boxShadow: "inset 0 1px 0 oklch(1 0 0 / 0.10), inset 0 -1px 0 oklch(0 0 0 / 0.22), 0 4px 16px oklch(0 0 0 / 0.35)" }}>
