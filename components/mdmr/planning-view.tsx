...
export function PlanningView() {
 ...
 className="input-glass rounded-xl border-white/[0.08] bg-transparent"
 />
 <Button
 type="button"
 onClick={() => {
 ...
 <form onSubmit={handleAddPiggyBank} className="glass-card flex flex-col gap-2 rounded-2xl p-4">
 ...
 <form onSubmit={handleAddGoal} className="rounded-2xl ">
 ...
 required
 />
 <div className="glass-card flex gap-2 rounded-xl p-1">
 <button
 type="button"
 ...
 return (
 <div key={goal.id} className="glass-card rounded-2xl p-3">
 ...
 <form onSubmit={handleAddFixedCost} className="rounded-2xl ">
